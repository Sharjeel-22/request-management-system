...
export default function CreateWorkflowPage() {
  ...
  const [steps, setSteps] = useState([
    {
      ...
      approver: "manager",
      customApprover: "",
      description: "Department manager reviews and approves the request",
    },
  ])
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Redirect to the workflows list page
  ...
  return (
    <div className="p-6 w-full min-h-screen">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-1">Design a custom approval workflow for resource requests in your organization</p>
      </div>
          ...
          <Card className="shadow-lg border-0 bg-gradient-to-br from-white to-blue-50">
            <CardHeader className="bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-t-lg">
              ...
              <CardDescription className="text-blue-100">
                Define the general settings and properties for your workflow
              </CardDescription>
            </CardHeader>
              ...
              <div className="flex flex-row items-center justify-between">
                <div>
                  ...
                  <CardDescription className="text-green-100">
                    Define the sequence of steps in your approval workflow
                  </CardDescription>
                </div>
                <Button 
                  type="button" 
